...
requirejs.config({
	...
	paths: {
		...
		"d3-collection": [
			"https://cdnjs.cloudflare.com/ajax/libs/d3-collection/1.0.5/d3-collection.min",
			"lib/d3-collection.min",
		],
		...
		"d3-interpolate": [
			"https://cdnjs.cloudflare.com/ajax/libs/d3-interpolate/1.3.0/d3-interpolate.min",
			"lib/d3-interpolate.min",
		],
		...
		"d3-time-format": [
			"https://cdnjs.cloudflare.com/ajax/libs/d3-time-format/2.1.1/d3-time-format.min",
			"lib/d3-time-format.min",
		],
